...
namespace SAP
{
    public partial class GoodsReceipt : System.Web.UI.Page
    {
        ...
        private string CurrentPageUrl = "/Inventory/GoodsReceipt.aspx";
        ...
        #region "Functions"
            ...
            public String _collectData()
            {
                try
                {
                    ...
                    Array arrContentsCols = new string[] { "Price", "LineTotal","Quantity" };
                    ds.Tables.Add(dtHeader.Copy());
                    ds.Tables.Add(GF.ResetFormatNumeric(dtContents.Copy(), arrContentsCols));
