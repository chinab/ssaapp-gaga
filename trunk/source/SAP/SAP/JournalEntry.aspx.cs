    ...
    public partial class JournalEntry : System.Web.UI.Page
    {
        ...
        public String _collectData()
        {
            try
            {
                ...
                return objInfo.ToXMLStringFromDS("30", dtHeader, GF.ResetFormatNumeric(dtContents, arrContentsCols), RemoveColumn);
            }
            catch (Exception)
            {
                throw;
        ...
        protected void btnAdd_Click(object sender, ImageClickEventArgs e)
        {
            ...
            DataSet ds = ts.CreateMarketingDocument(requestXML, User.Identity.Name,"30");
