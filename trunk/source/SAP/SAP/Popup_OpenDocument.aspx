<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Popup_OpenDocument.aspx.cs" Inherits="SAP.Popup_OpenDocument" %>
			...
			<asp:ListView ID="listWareHouses" runat="server">
				...
				<ItemTemplate>
					<tr>
						...
						<td>
							<asp:Label runat="server" ID="Label2"><%#Eval("DocEntry")%></asp:Label>
						</td>
						<td>
							<asp:Label runat="server" ID="Label3"><%#Eval("DocDate")%></asp:Label>
						</td>	
                        <td>
							<asp:Label runat="server" ID="Label4"><%#Eval("DocDueDate")%></asp:Label>
						</td>
						<td>
							<asp:Label runat="server" ID="Label5"><%#Eval("Comments")%></asp:Label>
						</td>	
                        <td>
							<asp:Label runat="server" ID="Label6"><%#Eval("DocTotal")%></asp:Label>
						</td>								
					</tr>
				</ItemTemplate>
				<EmptyDataTemplate>
