        ...
        #region "Fuctions"
            ...
            public String _collectData()
            {
                try
                {
                    ...
                    //Update table header
                    txtSubject.Text = "TIMESHEET | " + User.Identity.Name + " | " + Convert.ToDateTime(txtDate.Text, ivC).ToString("yyyyMMdd") + " | " + txtBP.Text;
        ...
        #region "Events"
                protected void Page_Load(object sender, EventArgs e)
                {
                    ...
                    if (!IsPostBack)
                    {
                        ...
                        try
                        {
                            ...
                            AttachmentPath = masterDataWS.GetCompanySetting(User.Identity.Name).Tables[0].Rows[0]["AttachPath"].ToString();
                ...
                protected void imgAdd_Click(object sender, ImageClickEventArgs e)
                {
                    try
                    {
                        ...
                        if ((int)ds.Tables[0].Rows[0]["ErrCode"] != 0)
                        {
                            ...
                            //Session["requestXML"] = requestXML;
                            ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "OKErrors",
                                "Main.setMasterMessage('" + ds.Tables[0].Rows[0]["ErrCode"] + "','');", true);
                        }
                        else
                        {
                ...
                protected void SubmitButton_Click(object sender, EventArgs e)
                {
                    if (FileUpload1.PostedFile != null)
                    {
                        ...
                        dtAttachment.Rows.Add(dtAttachment.Rows.Count,Path.GetFullPath(FileUpload1.FileName), AttachmentPath,FileUpload1.FileName, Path.GetExtension(FileUpload1.FileName),DateTime.Now.ToString("MM/dd/yyyy"));
