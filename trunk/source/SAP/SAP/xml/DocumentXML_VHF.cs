...
namespace SAP
{
    public class DocumentXML_VHF
    {
        ...
        public DocumentXML_VHF(String adminfo, String docdate, String docduedate, String taxdate,
        ...
        public String ToXMLString()
        {
            ...
            {
                writer.WriteStartElement(DocumentXML_VHF.ROOT_ELEMENT);
                {
                    writer.WriteStartElement(DocumentXML_VHF.BO_ELEMENT);
                    {
                        #region write ADMINFO_ELEMENT
                        writer.WriteStartElement(DocumentXML_VHF.ADMINFO_ELEMENT);
                        {
                            writer.WriteStartElement(DocumentXML_VHF.OBJECT_ELEMENT); // write object tag
                            {
                       ...
                       // writer.WriteStartElement(PurchaseInfo.OPOR_ELEMENT); // write OPOR tag
                        ...
                        {
                            writer.WriteStartElement(DocumentXML_VHF.ROW_ELEMENT);
                            {
                                writer.WriteStartElement(DocumentXML_VHF.DOCDATE_ELEMENT);
                                {
                                    writer.WriteString(this._DocDate);
                                }
                                writer.WriteEndElement();

                                writer.WriteStartElement(DocumentXML_VHF.DOCDUEDATE_ELEMENT);
                                {
                                ...
                                writer.WriteStartElement(DocumentXML_VHF.TAXDATE_ELEMENT);
                                {
                                    writer.WriteString(this._TaxDate);
                                }
                                writer.WriteEndElement();

                                writer.WriteStartElement(DocumentXML_VHF.CARDCODE_ELEMENT);
                                {
                                    writer.WriteString(this._CardCode);
                                }
                                writer.WriteEndElement();

                                writer.WriteStartElement(DocumentXML_VHF.CARDNAME_ELEMENT);
                                {
                                    writer.WriteString(this._CardName);
                                }
                                writer.WriteEndElement();

                                writer.WriteStartElement(DocumentXML_VHF.USERID_ELEMENT);
                                {
                            ...
                            if (_OrderItems != null)
                            {
                                writer.WriteStartElement(this.POR1_ELEMENT);
                                {
                                    for (int i = 0; i < _OrderItems.Count; i++)
                                    {
                                        ...
                                        writer.WriteStartElement(DocumentXML_VHF.ROW_ELEMENT);
                                            {
                                                writer.WriteStartElement(DocumentXML_VHF.ITEMCODE_ELEMENT); //write item _PrjCode
                                                {
                                                ...
                                                writer.WriteStartElement(DocumentXML_VHF.DES_ELEMENT); //write Dscription
                                                {
                                                ...
                                                writer.WriteStartElement(DocumentXML_VHF.QUANTITY_ELEMENT); //write Quantity
                                                {
                                                ...
                                                writer.WriteStartElement(DocumentXML_VHF.DISPERCENT_ELEMENT); //write DiscPrcnt
                                                {
                                                ...
                                                writer.WriteStartElement(DocumentXML_VHF.WHSCODE_ELEMENT); //write WhsCode
                                                {
                                                ...
                                                writer.WriteStartElement(DocumentXML_VHF.VATGRP_ELEMENT); //write VATGroup
                                                {
                                                ...
                                                writer.WriteStartElement(DocumentXML_VHF.UNITPRICE_ELEMENT); //Unit Price
                                                {
                                                ...
                                                {
                                                    writer.WriteStartElement(DocumentXML_VHF.GLACCT_ELEMENT); //Unit Price
                                                    {
